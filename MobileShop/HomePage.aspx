    <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomePage.aspx.cs" Inherits="MobileShop.HomePage" %>
    ...
    <!-- Main Menu-->
        ...
        <div class="container-fluid">
            <div class="row">
                    ...
                    <asp:Panel runat="server" ID="image_card" align="center"></asp:Panel>
                </div>
        <!-- Product-->
