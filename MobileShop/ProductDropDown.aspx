<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductDropDown.aspx.cs" Inherits="MobileShop.ProductDropDown" %>
...
<form id = "form1" runat="server">
    ...
    <a class="dropdown-item" href="Policy.aspx">Policy</a>
        ...
        <!-- Product-->
                     ...
                     <asp:Panel runat="server" ID="pnl_btns" align="center"></asp:Panel>
