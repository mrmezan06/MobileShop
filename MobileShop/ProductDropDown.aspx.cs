...
namespace MobileShop
{
    public partial class ProductDropDown : System.Web.UI.Page
    {
        ...
        public void DataDisplay()
        {
            ...
            {
                setname = Session["selected"].ToString();   
                
            }

            SqlCommand sqlCmd = new SqlCommand("select Id,Name,Price,ImageURL,Details from Info where Name LIKE '%"+setname+"%';", sqlConn);
            ...
            while (sqlReader.Read())
            {
                ...
                lbldetails.CssClass = "card-title";
                lbldetails.Font.Size = 24;
                pnl_btns.Controls.Add(lbldetails);
